...
<style>.wp-tab-panel{display: block; border-top: none;}h2{font-size:1.7em;}.hndle, .hndle-first{padding-bottom: 12px; border-bottom: 1px solid #e1e1e1; margin-bottom: 12px;}h2.hndle{border-top: 1px solid #e1e1e1;}.stl{color: #0073aa;}#success, #fail{margin: 0 20px 20px 0; max-width: 400px; background-color: #f7f7f7; box-shadow: 0 1px 1px 0 rgba(0,0,0,.1); padding: 1px 12px;}#success{border-left: 4px solid #46b450;}#fail{border-left: 4px solid #dc3232;}.wp-tab-panel ul{margin-left: 40px; list-style-type: square;}</style>
	...
	?>
		...
		<div class="wp-tab-panel">
			...
			<h2 class="hndle-first"><span>Connecting to your PonoRez account</span></h2>
			...
			<p>		
				...
				<div id="success"><p><strong>You have successfully connected to your PonoRez account.</strong></p></div>
			</p>
			<p>
				However, if the provided credetials are not correct you will see an error message 
				<div id="fail"><p><strong>Login failed. Please check your PonoRez account credetials!</strong></p></div>
				in which case you need to make sure you have to check and update them.
			</p>

			<h2 class="hndle"><span>Configuring plugin options</span></h2>
			...
			<p><strong class="stl">Primary color</strong> will let you set the color used for the default state of all buttons and calendar icon.</p>
			<p><strong class="stl">Secondary color</strong>  will let you set the color used for the mouse over state of the buttons and calendar icon.</p>
			<p><strong class="stl">Text color</strong> will let you set the color used for the buttons text.</p>
			<p>The <strong class="stl">Set Book Now Button text</strong> will let you set the text you want your buttons to show (ex. <strong>Book Now</strong> or <strong>Make Reservation</strong> etc).</p>
			...
			<p>By checking this options you will globally enable the usage of <strong class="stl">Accommodation and Transportation</strong> options in your booking forms.</p>
			...
			<p>By checking this option you will globally enable the usage of <strong class="stl">Promotional Codes</strong> options in your booking forms.</p>
			...
			<h2 class="hndle"><span>Available Activities</span></h2>
			<p>After a sucessfull connection to PonoRez server this plugin will retreive all activites associated with your account.</p>
			<p>To view the full list of available activites go to <strong class="stl">Activities List</strong> tab.</p>

			<h2 class="hndle"><span>Available Activity Groups</span></h2>
			...
			<h2 class="hndle"><span>Displaying an activity booking form on your website</span></h2>
			...
			<h2 class="hndle"><span>Displaying a group booking form on your website</span></h2>
			...
			<h2 class="hndle"><span>Guest Type Configuration</span></h2>
			...
			<p>The guest type IDs must be identical to the ones defined in your PonoRez account dashboard. If you are not sure what guest types to use please check this information by logging into your PonoRez account dashboard and navigating to <strong class="stl">Settings > Guest Types</strong>.</p>
			...
			<h2 class="hndle"><span>Upgrade Type Configuration</span></h2>
			...
			<p>The upgrade type IDs must be identical to the ones defined in your PonoRez account dashboard. If you are not sure what upgrade types to use please check this information by logging into your PonoRez account dashboard and navigating to <strong class="stl">Settings > Upgrades &amp; Surcharges</strong>.</p>
			...
			<h2 class="hndle"><span>Google Analytics Setup</span></h2>
	...
	?>
		...
		<div class="wp-tab-panel">
			...
			<h3 class="hndle"><span>How to use the single activity shortcode</span></h3>
			...
			<h3 class="hndle"><span>Other parameters</span></h3>
			...
			<p>Currently, this plugin can be used to generate up to 14 booking form on the same page by using the following shortcode variations:</p>
	...
	?>
		...
		<div class="wp-tab-panel">
			...
			<h3 class="hndle"><span>How to use the activities group shortcode</h2></span></h3>

...
<form class="booking-form ponorezActivity-<?php echo $myActivityID; ?> clearfix">
	...
	?>
		...
		<div class="form-row date-selector">
			<input class="form-control" id='date_a<?php echo $myActivityID; ?>' onclick='showMinAvailable13()'>
	...
	<?php	
			...
			if(!empty( $couponsStatusCheck ) && $promotionalCodesStatus == 'yes') {
				...
				echo '<div class="form-row">';
				echo '<label>Promotional Code</label>';
				echo '<input class="form-control" type="text" id="promotionalcode_a' . $myActivityID . '" />';
				echo '</div>';
				
				echo $promoCodeFieldJS;

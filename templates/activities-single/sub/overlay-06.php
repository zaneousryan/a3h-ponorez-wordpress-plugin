			...
			<form class="booking-form ponorezActivity-<?php echo $activityModelId; ?>">
				...
				<div class="modal-body">
					...
					<?php 
						...
						echo '<div id="availableGuests'. $activityModelId . '" class="hide-guest06">';
						...
						?>
							...
							<div class="form-row date-selector hide-this">
								<input class="form-control" id='date_a<?php echo $activityModelId; ?>' onclick='showMinAvailable6()' value='<?php echo $selected_date;?>'>
							...
							if($fix_guest == '1'){
								?>
								<style type="text/css">.hide-guest06{
									display: none;
								}</style>

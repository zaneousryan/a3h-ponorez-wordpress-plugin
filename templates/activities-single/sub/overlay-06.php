<div id="wrapper-<?php echo $myActivityID; ?>-06">
	...
	<!-- Trigger/Open Modal -->
	<a class="button button-book-now" href="#modal-<?php echo $myActivityID; ?>-06" rel="modal:open"><?php echo $bookNowText; ?></a>
	
	<!-- The Modal -->
	<div id="modal-<?php echo $myActivityID; ?>-06" class="ponorezmodal">
			...
			<form class="booking-form ponorezActivity-<?php echo $myActivityID; ?>">
				...
				<div class="modal-body">
					...
					<?php 
						...
						echo '<div id="availableGuests'. $myActivityID . '" class="hide-guest06">';

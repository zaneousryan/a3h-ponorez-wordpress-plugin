<div id="wrapper-<?php echo $activityModelId; ?>-07">
			...
			<form class="booking-form ponorezActivity-<?php echo $activityModelId; ?>">
				...
				<div class="modal-body">
					...
					<?php 
						...
						echo '<div id="availableGuests'. $activityModelId . '" class="hide-guest07">';
						...
						?>
							...
							<div class="form-row date-selector hide-this">
								<input class="form-control" id='date_a<?php echo $activityModelId; ?>' onclick='showMinAvailable7()' value='<?php echo $selected_date;?>'>
									<a onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" href="javascript:showMinAvailable7();">
							...
							if($fix_guest == '1'){
								?>
								<style type="text/css">.hide-guest07{
									display: none;
								}</style>
								<script type="text/javascript">
									jQuery('.hide-guest07 input[name=guestCheckbox]').click();
									jQuery('.hide-guest07 select').val(1);

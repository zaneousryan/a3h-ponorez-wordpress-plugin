<div id="wrapper-<?php echo $myActivityID; ?>-01">
	...
	<!-- Trigger/Open Modal -->
	<a class="button button-book-now" href="#modal-<?php echo $myActivityID; ?>-01" rel="modal:open"><?php echo $bookNowText; ?></a>
	
	<!-- The Modal -->
	<div id="modal-<?php echo $myActivityID; ?>-01" class="ponorezmodal">
			...
			<form class="booking-form ponorezActivity-<?php echo $myActivityID; ?>">
				...
				<div class="modal-body">
					...
					<?php 
						...
						echo '<div id="availableGuests'. $myActivityID . '" class="hide-guest01">';
						...
						?>
							...
							<div class="form-row date-selector">
								<input class="form-control" id='date_a<?php echo $myActivityID; ?>' onclick='showMinAvailable1()'>

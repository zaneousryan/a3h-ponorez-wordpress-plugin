			...
			<form class="booking-form ponorezActivity-<?php echo $activityModelId; ?>">
				...
				<div class="modal-body">
					...
					<?php 
						...
						echo '<div id="availableGuests'. $activityModelId . '" class="hide-guest01">';
						...
						?>
							...
							if($fix_guest == '1'){
								?>
								<style type="text/css">.hide-guest01{
									display: none;
								}</style>
								<script type="text/javascript">
									jQuery('.hide-guest01 input[name=guestCheckbox]').click();
									jQuery('.hide-guest01 select').val(1);

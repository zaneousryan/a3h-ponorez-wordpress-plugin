<div id="wrapper-<?php echo $activityModelId; ?>-04">
	...
	<!-- Trigger/Open Modal -->
	<a class="button button-book-now" href="#modal-<?php echo $activityModelId; ?>-04" rel="modal:open"><?php echo $bookNowText; ?></a>
	
	<!-- The Modal -->
	<div id="modal-<?php echo $activityModelId; ?>-04" class="ponorezmodal">

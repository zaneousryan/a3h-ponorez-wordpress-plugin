			...
			<form class="booking-form ponorezActivity-<?php echo $activityModelId; ?>">
				...
				<div class="modal-body">
					...
					<?php 
						...
						echo '<div id="availableGuests'. $activityModelId . '" class="hide-guest04">';
						...
						?>
							...
							<div class="form-row date-selector hide-this">
								<input class="form-control" id='date_a<?php echo $activityModelId; ?>' onclick='showMinAvailable4()' value='<?php echo $selected_date;?>'>
									<a onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" href="javascript:showMinAvailable4();">

			...
			<form class="booking-form ponorezActivity-<?php echo $myActivityID; ?>">
				...
				<div class="modal-body">
					...
					<?php 
						...
						echo '<div id="availableGuests'. $myActivityID . '" class="hide-guest04">';
						...
						?>
							...
							if($fix_guest == '1'){
								...
								if ($guest_id[0] == '2333'){
									...
									<script type="text/javascript">
										jQuery('.hide-guest04 input[name=guestCheckbox]').click();
										jQuery('.hide-guest04 input[name=guestCheckbox]').parent().css('display','none');
									</script>
									<?php
									...
									<script type="text/javascript">
										jQuery('.hide-guest04 select').val(1);
										jQuery('.hide-guest04 select').parent().css('display','none');

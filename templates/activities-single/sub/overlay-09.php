<div id="wrapper-<?php echo $activityModelId; ?>-09">
	...
	<!-- Trigger/Open Modal -->
	<a class="button button-book-now" href="#modal-<?php echo $activityModelId; ?>-08" rel="modal:open"><?php echo $bookNowText; ?></a>
	
	<!-- The Modal -->
	<div id="modal-<?php echo $activityModelId; ?>-08" class="ponorezmodal">
			...
			<form class="booking-form ponorezActivity-<?php echo $activityModelId; ?>">
				...
				<div class="modal-body">
					...
					<?php 
						...
						echo '<div id="availableGuests'. $activityModelId . '" class="hide-guest09">';
						...
						?>
							...
							if($fix_guest == '1'){
								?>
								<style type="text/css">.hide-guest09{
									display: none;
								}</style>
								<script type="text/javascript">
									jQuery('.hide-guest09 input[name=guestCheckbox]').click();
									jQuery('.hide-guest09 select').val(1);

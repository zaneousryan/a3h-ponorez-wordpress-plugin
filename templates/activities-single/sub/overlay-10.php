<div id="wrapper-<?php echo $activityModelId; ?>-10">
			...
			<form class="booking-form ponorezActivity-<?php echo $activityModelId; ?>">
				...
				<div class="modal-body">
					...
					<?php 
						...
						echo '<div id="availableGuests'. $activityModelId . '" class="hide-guest10">';
						...
						?>
							...
							<div class="form-row date-selector hide-this">
								<input class="form-control" id='date_a<?php echo $activityModelId; ?>' onclick='showMinAvailable10()' value='<?php echo $selected_date;?>'>
									<a onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" href="javascript:showMinAvailable10();">
							...
							if($fix_guest == '1'){
								?>
								<style type="text/css">.hide-guest10{
									display: none;
								}</style>
								<script type="text/javascript">
									jQuery('.hide-guest10 input[name=guestCheckbox]').click();
									jQuery('.hide-guest10 select').val(1);

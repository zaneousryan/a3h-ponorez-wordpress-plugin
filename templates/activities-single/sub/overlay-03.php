<div id="wrapper-<?php echo $myActivityID; ?>">
	...
	<div style="text-align: center;">
		<a href="#modal-Table" rel="modal:open"><img class="image_picker_image" src="<?php echo plugins_url() . '/a3h-ponorez-wordpress-plugin/assets/images/table-chairs.jpg'; ?>" /></a><br>
		<p style="text-align: left;">Enjoy the comfort of sitting at a dining table on chairs. Tables accommodate eight (8) luau guests. If your party does not occupy all seats at a table , there will be other luau guests seated with your party.</p>
		<a class="button button-book-now" href="#modal-Table" rel="modal:open"><?php echo $bookNowText; ?></a>
	</div>
	
	<!-- The Modal -->
	<div id="modal-Table" class="ponorezmodal">

		<!-- Modal content -->
		<div class="modal-content">

			<form class="booking-form ponorezActivity-Table">
					...
					<?php 
						...
						?>
							...
							<div class="form-row date-selector">
								<input class="form-control date" id='date_Table' onclick='showMinAvailable3()'>

			...
			<form class="booking-form ponorezActivity-<?php echo $activityModelId; ?>">
				...
				<div class="modal-body">
					...
					<?php 
						...
						echo '<div id="availableGuests'. $activityModelId . '" class="hide-guest05">';
						...
						?>
							...
							<div class="form-row date-selector hide-this">
								<input class="form-control" id='date_a<?php echo $activityModelId; ?>' onclick='showMinAvailable5()' value='<?php echo $selected_date;?>'>
									<a onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" href="javascript:showMinAvailable5();">
							...
							if($fix_guest == '1'){
								?>
								<style type="text/css">.hide-guest05{
									display: none;
								}</style>
								<script type="text/javascript">
									jQuery('.hide-guest05 input[name=guestCheckbox]').click();
									jQuery('.hide-guest05 select').val(1);

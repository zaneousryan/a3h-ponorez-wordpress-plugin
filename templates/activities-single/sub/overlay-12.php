<div id="wrapper-<?php echo $activityModelId; ?>-12">
	...
	<!-- Trigger/Open Modal -->
	<a class="button button-book-now" href="#modal-<?php echo $activityModelId; ?>-12" rel="modal:open"><?php echo $bookNowText; ?></a>
	
	<!-- The Modal -->
	<div id="modal-<?php echo $activityModelId; ?>-12" class="ponorezmodal">
			...
			<form class="booking-form ponorezActivity-<?php echo $activityModelId; ?>">
				...
				<div class="modal-body">
					...
					<?php 
						...
						echo '<div id="availableGuests'. $activityModelId . '" class="hide-guest12">';
						...
						?>
							...
							if($fix_guest == '1'){
								?>
								<style type="text/css">.hide-guest12{
									display: none;
								}</style>
								<script type="text/javascript">
									jQuery('.hide-guest12 input[name=guestCheckbox]').click();
									jQuery('.hide-guest12 select').val(1);

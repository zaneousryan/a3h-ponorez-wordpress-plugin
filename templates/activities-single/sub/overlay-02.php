<div id="wrapper-<?php echo $activityModelId; ?>">
	...
	<!-- Trigger/Open Modal -->
	<a class="pr-btn-book-now" id="ponorez-book-button-<?php echo $overlayId; ?>" href="#modal-<?php echo $activityModelId; ?>" rel="modal:open"><?php echo $bookNowText; ?></a>
			...
			<form class="booking-form ponorezActivity-<?php echo $activityModelId; ?>">
				...
				<div class="modal-body">
					...
					<?php 					
						...
						echo '<div id="availableGuests'. $activityModelId . '" class="hide-guest02">';
						...
						?>
							...
							<div class="form-row date-selector hide-this">
								<input class="form-control" id='date_a<?php echo $activityModelId; ?>' onclick='showMinAvailable2()' value='<?php echo $selected_date;?>'>
							...
							if($fix_guest == '1'){
								?>
								<style type="text/css">.hide-guest02{
									display: none;
								}</style>
								<script type="text/javascript">
									jQuery('.hide-guest02 input[name=guestCheckbox]').click();
									jQuery('.hide-guest02 select').val(1);

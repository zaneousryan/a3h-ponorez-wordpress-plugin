<div id="wrapper-<?php echo $activityModelId; ?>-14">
	...
	<!-- Trigger/Open Modal -->
	<a class="button button-book-now" href="#modal-<?php echo $activityModelId; ?>-14" rel="modal:open"><?php echo $bookNowText; ?></a>
	
	<!-- The Modal -->
	<div id="modal-<?php echo $activityModelId; ?>-14" class="ponorezmodal">
			...
			<form class="booking-form ponorezActivity-<?php echo $activityModelId; ?>">
				...
				<div class="modal-body">
					...
					<?php 
						...
						echo '<div id="availableGuests'. $activityModelId . '" class="hide-guest14">';
						...
						?>
							...
							if($fix_guest == '1'){
								?>
								<style type="text/css">.hide-guest14{
									display: none;
								}</style>
								<script type="text/javascript">
									jQuery('.hide-guest14 input[name=guestCheckbox]').click();
									jQuery('.hide-guest14 select').val(1);

<div id="wrapper-<?php echo $activityModelId; ?>-13">
			...
			<form class="booking-form ponorezActivity-<?php echo $activityModelId; ?>">
				...
				<div class="modal-body">
					...
					<?php 
						...
						echo '<div id="availableGuests'. $activityModelId . '" class="hide-guest13">';
						...
						?>
							...
							<div class="form-row date-selector hide-this">
								<input class="form-control" id='date_a<?php echo $activityModelId; ?>' onclick='showMinAvailable13()' value='<?php echo $selected_date;?>'>
									<a onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" href="javascript:showMinAvailable13();">
							...
							if($fix_guest == '1'){
								?>
								<style type="text/css">.hide-guest13{
									display: none;
								}</style>
								<script type="text/javascript">
									jQuery('.hide-guest13 input[name=guestCheckbox]').click();
									jQuery('.hide-guest13 select').val(1);

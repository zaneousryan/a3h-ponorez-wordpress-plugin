<div id="wrapper-<?php echo $activityModelId; ?>-08">
			...
			<form class="booking-form ponorezActivity-<?php echo $activityModelId; ?>">
				...
				<div class="modal-body">
					...
					<?php 
						...
						echo '<div id="availableGuests'. $activityModelId . '" class="hide-guest08">';
						...
						?>
							...
							<div class="form-row date-selector hide-this">
								<input class="form-control" id='date_a<?php echo $activityModelId; ?>' onclick='showMinAvailable8()' value='<?php echo $selected_date;?>'>
									<a onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" href="javascript:showMinAvailable8();">
							...
							if($fix_guest == '1'){
								?>
								<style type="text/css">.hide-guest08{
									display: none;
								}</style>
								<script type="text/javascript">
									jQuery('.hide-guest08 input[name=guestCheckbox]').click();
									jQuery('.hide-guest08 select').val(1);

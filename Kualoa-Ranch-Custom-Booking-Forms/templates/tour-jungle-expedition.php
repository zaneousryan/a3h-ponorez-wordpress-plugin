<!-- The Modal -->
<div id="modal-jungle-expedition" class="ponorezmodal">
		...
		<form class="booking-form">
			...
			<script type="text/javascript">
				...
				var group1005 = {
					...
					supplierid: 225,
					activityids: [ 7557, 7737, 7571, 7752, 7573, 7739, 7576, 7702, 7577 ],
					guesttypeids:[ 274,1554 ],
					
					activityprices: {
						
						7557: { 274: 51.26, 1554: 38.69 },
						7737: { 274: 51.26, 1554: 38.69 },
						7571: { 274: 51.26, 1554: 38.69 },
						7752: { 274: 51.26, 1554: 38.69 },
						7573: { 274: 51.26, 1554: 38.69 },
						7739: { 274: 51.26, 1554: 38.69 },
						7576: { 274: 51.26, 1554: 38.69 },
						7702: { 274: 51.26, 1554: 38.69 },
						7577: { 274: 51.26, 1554: 38.69 }
						
					},
					
					datecontrolid: "date_g1005",
					pricecontrolid: "price_g1005",
					...
					activitydescriptioncontrolids: {
						...
						7557: "activity_7557_description",
						7737: "activity_7737_description",
						7571: "activity_7571_description",
						7752: "activity_7752_description",
						7573: "activity_7573_description",
						7739: "activity_7739_description",
						7576: "activity_7576_description",
						7702: "activity_7702_description",
						7577: "activity_7577_description"
					
					},
					
					activitynotavailablemessagecontrolids: {
						
						7557: "activity_7557_notavailablemessage",
						7737: "activity_7737_notavailablemessage",
						7571: "activity_7571_notavailablemessage",
						7752: "activity_7752_notavailablemessage",
						7573: "activity_7573_notavailablemessage",
						7739: "activity_7739_notavailablemessage",
						7576: "activity_7576_notavailablemessage",
						7702: "activity_7702_notavailablemessage",
						7577: "activity_7577_notavailablemessage"
						
					},

					guesttypecontrolids: {
						
						274: "guests_g1005_t274",
						1554: "guests_g1005_t1554"
				...
				function bookJungleExpedition(group) {
					...
					setpromotionalcode(document.getElementById('promotionalcode_g1005').value); 
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h3>Jurassic Jungle Expedition Tour</h3> <a class="close" href="#" rel="modal:close"><i class="fa fa-times" aria-hidden="true"></i></a>
					...
					<div class="modal-body" data-step="1">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g1005_t274" onchange="showPriceAndAvailability(group1005);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g1005_t1554" onchange="showPriceAndAvailability(group1005);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper date-selector">
								<input id="date_g1005" class="form-control browser-default" onclick="showCalendar(group1005);" onchange="showPriceAndAvailability(group1005);" readOnly />
								<a onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" href="javascript:showCalendar(group1005);" style="vertical-align: middle;"><i class="fa fa-calendar" aria-hidden="true"></i></a>
							</div>
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select id="jungle-expedition-times" class="groupSelect form-control activity-time browser-default" onchange="showPriceAndAvailability(group1005);" onclick="showPriceAndAvailability(group1005);">

									<option value="0" onclick="selectActivity(group1005, this); showPriceAndAvailability(group1005);">Select time</option>

									  <option id="activity_7557" onclick="selectActivity(group1005, this); showPriceAndAvailability(group1005);"> 8:45 AM </option>
									  <option id="activity_7737" onclick="selectActivity(group1005, this); showPriceAndAvailability(group1005);"> 9:15 AM </option>
									  <option id="activity_7571" onclick="selectActivity(group1005, this); showPriceAndAvailability(group1005);"> 10:30 AM </option>
									  <option id="activity_7752" onclick="selectActivity(group1005, this); showPriceAndAvailability(group1005);"> 11:00 AM </option>
									  <option id="activity_7573" onclick="selectActivity(group1005, this); showPriceAndAvailability(group1005);"> 12:45 PM </option>
									  <option id="activity_7739" onclick="selectActivity(group1005, this); showPriceAndAvailability(group1005);"> 1:15 PM </option>
									  <option id="activity_7576" onclick="selectActivity(group1005, this); showPriceAndAvailability(group1005);"> 2:30 PM </option>
									  <option id="activity_7702" onclick="selectActivity(group1005, this); showPriceAndAvailability(group1005);"> 3:00 PM </option>
									  <option id="activity_7577" onclick="selectActivity(group1005, this); showPriceAndAvailability(group1005);"> 3:30 PM </option>

								</select>
								
								<script>
									
									$("#jungle-expedition-times").bind("click", function() {
									
										if ( $('body select#jungle-expedition-times:not(:disabled) option:not(:disabled)').length == 1 && $('body select#jungle-expedition-times:not(:disabled) option:not(:disabled)').val() == '0' ) {
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<input type="text" class="form-control" id="promotionalcode_g1005" size="8">
						...
						<div class="form-row total-price">
							<label>Total Price with taxes: <span id="price_g1005"></span></label>
						</div>
					...
					<div class="modal-footer">
						...
						<a href="#" class="btn btn-default btn-book-now" onclick="bookJungleExpedition(group1005);">Book Now</a>

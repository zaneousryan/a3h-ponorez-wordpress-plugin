<!-- The Modal -->
<div id="modal-1hour-atv" class="ponorezmodal">
		...
		<form class="booking-form">
			...
			<script type="text/javascript">
				...
				var group1010 = {
					...
					supplierid: 225,
					activityids: [ 7602, 7603, 7604, 7605, 7606, 7607, 7608, 7609, 7610 ],
					guesttypeids: [ 274 ],
					...
					datecontrolid: "date_g1010",
					pricecontrolid: "price_g1010",
					...
					activitydescriptioncontrolids: {
						...
						7602: "activity_7602_description",
						7603: "activity_7603_description",
						7604: "activity_7604_description",
						7605: "activity_7605_description",
						7606: "activity_7606_description",
						7607: "activity_7607_description",
						7608: "activity_7608_description",
						7609: "activity_7609_description",
						7610: "activity_7610_description"
						
					},
					
					activitynotavailablemessagecontrolids: {
						
						7602: "activity_7602_notavailablemessage",
						7603: "activity_7603_notavailablemessage",
						7604: "activity_7604_notavailablemessage",
						7605: "activity_7605_notavailablemessage",
						7606: "activity_7606_notavailablemessage",
						7607: "activity_7607_notavailablemessage",
						7608: "activity_7608_notavailablemessage",
						7609: "activity_7609_notavailablemessage",
						7610: "activity_7610_notavailablemessage"
						
					},
					
					guesttypecontrolids: {
						
						274: "guests_g1010_t274"
				...
				function book1hrATV(group) {
					...
					setpromotionalcode(document.getElementById('promotionalcode_g1010').value); 
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h3>1-Hour ATV Tour</h3> <a class="close" href="#" rel="modal:close"><i class="fa fa-times" aria-hidden="true"></i></a>
					...
					<div class="modal-body" data-step="1">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g1010_t274" onchange="showPriceAndAvailability(group1010);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper date-selector">
								<input id="date_g1010" class="form-control browser-default" onclick="showCalendar(group1010);" onchange="showPriceAndAvailability(group1010);" readOnly />
								<a onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" href="javascript:showCalendar(group1010);" style="vertical-align: middle;"><i class="fa fa-calendar" aria-hidden="true"></i></a>
							</div>
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select id="1hr-atv-times" class="groupSelect form-control activity-time browser-default" onchange="showPriceAndAvailability(group1010);" onclick="showPriceAndAvailability(group1010);">

									<option value="0" onclick="selectActivity(group1010, this); showPriceAndAvailability(group1010);">Select time</option>

									<option id="activity_7602" onclick="selectActivity(group1010, this); showPriceAndAvailability(group1010);"> 8:45 AM </option>
									<option id="activity_7603" onclick="selectActivity(group1010, this); showPriceAndAvailability(group1010);"> 9:15 AM </option>
									<option id="activity_7604" onclick="selectActivity(group1010, this); showPriceAndAvailability(group1010);"> 10:30 AM </option>
									<option id="activity_7605" onclick="selectActivity(group1010, this); showPriceAndAvailability(group1010);"> 10:45 AM </option>
									<option id="activity_7606" onclick="selectActivity(group1010, this); showPriceAndAvailability(group1010);"> 11:45 AM </option>
									<option id="activity_7607" onclick="selectActivity(group1010, this); showPriceAndAvailability(group1010);"> 12:00 PM </option>
									<option id="activity_7608" onclick="selectActivity(group1010, this); showPriceAndAvailability(group1010);"> 1:00 PM </option>
									<option id="activity_7609" onclick="selectActivity(group1010, this); showPriceAndAvailability(group1010);"> 1:15 PM </option>
									<option id="activity_7610" onclick="selectActivity(group1010, this); showPriceAndAvailability(group1010);"> 2:30 PM </option>

								</select>
								
								<script>
									
									$("#1hr-atv-times").bind("click", function() {
									
										if ( $('body select#1hr-atv-times:not(:disabled) option:not(:disabled)').length == 1 && $('body select#1hr-atv-times:not(:disabled) option:not(:disabled)').val() == '0' ) {
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<input type="text" class="form-control" id="promotionalcode_g1010" size="8">
						...
						<div class="form-row total-price">
							<label>Total Price with taxes: <span id="price_g1010"></span></label>
						</div>
					...
					<div class="modal-footer">
						...
						<a href="#" class="btn btn-default btn-book-now" onclick="book1hrATV(group1010);">Book Now</a>

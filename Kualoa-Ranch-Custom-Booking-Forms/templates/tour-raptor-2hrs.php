<!-- The Modal -->
<div id="modal-2hour-raptor" class="ponorezmodal">
		...
		<form class="booking-form">
			...
			<script type="text/javascript">
				...
				var group1016 = {
					...
					supplierid: 225,
					activityids: [ 8448, 8462, 8463, 8464, 8465, 12967, 8466 ],
					guesttypeids: [ 274, 1554 ],
					
					activityprices: { 
						
						8448: { 274: 144.45, 1554: 73.25 },
						8462: { 274: 144.45, 1554: 73.25 },
						8463: { 274: 144.45, 1554: 73.25 },
						8464: { 274: 144.45, 1554: 73.25 },
						12967: { 274: 144.45, 1554: 73.25 },
						8465: { 274: 144.45, 1554: 73.25 },
						8466: { 274: 144.45, 1554: 73.25 }
						
					},
					
					datecontrolid: "date_g1016",
					pricecontrolid: "price_g1016",
					...
					activitydescriptioncontrolids: {
						...
						8448: "activity_8448_description",
						8462: "activity_8462_description",
						8463: "activity_8463_description",
						8464: "activity_8464_description",
						12967: "activity_12967_description",
						8465: "activity_8465_description",
						8466: "activity_8466_description"
						
					},
					
					activitynotavailablemessagecontrolids: {
						
						8448: "activity_8448_notavailablemessage",
						8462: "activity_8462_notavailablemessage",
						8463: "activity_8463_notavailablemessage",
						8464: "activity_8464_notavailablemessage",
						12967: "activity_12967_notavailablemessage",
						8465: "activity_8465_notavailablemessage",
						8466: "activity_8466_notavailablemessage"
					},
					
					guesttypecontrolids: {
						
						274: "guests_g1016_t274",
						1554: "guests_g1016_t1554"
				...
				function book2hoursRaptor(group) {
					...
					setpromotionalcode(document.getElementById('promotionalcode_g1016').value); 
					
					var adultGuests = document.getElementById('guests_g1016_t274').value,
						childGuests = document.getElementById('guests_g1016_t1554').value,
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h3>2-Hour ATV Raptor Tour</h3> <a class="close" href="#" rel="modal:close"><i class="fa fa-times" aria-hidden="true"></i></a>
					...
					<div class="modal-body" data-step="1">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g1016_t274" onchange="showPriceAndAvailability(group1016);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g1016_t1554" onchange="showPriceAndAvailability(group1016);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper date-selector">
								<input id="date_g1016" class="form-control browser-default" onclick="showCalendar(group1016);" onchange="showPriceAndAvailability(group1016);" readOnly />
								<a onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" href="javascript:showCalendar(group1016);" style="vertical-align: middle;"><i class="fa fa-calendar" aria-hidden="true"></i></a>
							</div>
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select id="2hr-raptor-times" class="groupSelect form-control activity-time browser-default" onchange="showPriceAndAvailability(group1016);" onclick="showPriceAndAvailability(group1016);">

									<option value="0" onclick="selectActivity(group1016, this); showPriceAndAvailability(group1016);">Select time</option>

									<option id="activity_8448" onclick="selectActivity(group1016, this); showPriceAndAvailability(group1016);"> 8:30 AM </option>
									<option id="activity_8462" onclick="selectActivity(group1016, this); showPriceAndAvailability(group1016);"> 9:30 AM </option>
									<option id="activity_8463" onclick="selectActivity(group1016, this); showPriceAndAvailability(group1016);"> 11:15 AM </option>
									<option id="activity_8464" onclick="selectActivity(group1016, this); showPriceAndAvailability(group1016);"> 12:15 PM </option>
									<option id="activity_8465" onclick="selectActivity(group1016, this); showPriceAndAvailability(group1016);"> 1:30 PM </option>
									<option id="activity_12967" onclick="selectActivity(group1016, this); showPriceAndAvailability(group1016);"> 2:30 PM </option>
									<option id="activity_8466" onclick="selectActivity(group1016, this); showPriceAndAvailability(group1016);"> 3:30 PM </option>
									
								</select>
								
								<script>
									
									$("#2hr-raptor-times").bind("click", function() {
									
										if ( $('body select#2hr-raptor-times:not(:disabled) option:not(:disabled)').length == 1 && $('body select#2hr-raptor-times:not(:disabled) option:not(:disabled)').val() == '0' ) {
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<input type="text" class="form-control" id="promotionalcode_g1016" size="8">
						...
						<div class="form-row total-price">
							<label>Total Price with taxes: <span id="price_g1016"></span></label>
						</div>
					...
					<div class="modal-footer">
						...
						<a href="#" class="btn btn-default btn-book-now" onclick="book2hoursRaptor(group1016);">Book Now</a>

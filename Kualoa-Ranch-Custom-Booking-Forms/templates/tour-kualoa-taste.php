<!-- The Modal -->
<div id="modal-taste-of-kualoa" class="ponorezmodal">
		...
		<form class="booking-form">
			...
			<script type="text/javascript">
				...
				var group1009 = {
					...
					supplierid: 225,
					activityids: [ 8629, 8630, 12411, 8631, 8632, 12412, 8633, 8634, 12413, 10549 ],
					guesttypeids: [ 274, 1554, 1190 ],

					activityprices: {
						
						8629: { 274: 51.26, 1554: 38.69, 1190: 0.00 },
						8630: { 274: 51.26, 1554: 38.69, 1190: 0.00 },
						12411: { 274: 51.26, 1554: 38.69, 1190: 0.00 },
						8631: { 274: 51.26, 1554: 38.69, 1190: 0.00 },
						8632: { 274: 51.26, 1554: 38.69, 1190: 0.00 },
						12412: { 274: 51.26, 1554: 38.69, 1190: 0.00 },
						8633: { 274: 51.26, 1554: 38.69, 1190: 0.00 },
						8634: { 274: 51.26, 1554: 38.69, 1190: 0.00 },
						12413: { 274: 51.26, 1554: 38.69, 1190: 0.00 },
						10549: { 274: 51.26, 1554: 38.69, 1190: 0.00 }
						
					},

					datecontrolid: 'date_g1009',
					pricecontrolid: 'price_g1009',

					activitycheckboxcontrolids: {
						
						8629: "activity_8629",
						8630: "activity_8630",
						12411: "activity_12411",
						8631: "activity_8631",
						8632: "activity_8632",
						12412: "activity_12412",
						8633: "activity_8633",
						8634: "activity_8634",
						12413: "activity_12413",
						10549: "activity_10549"
						
					},
					
					activitydescriptioncontrolids: {
					
						8629: "activity_8629_description",
						8630: "activity_8630_description",
						12411: "activity_12411_description",
						8631: "activity_8631_description",
						8632: "activity_8632_description",
						12412: "activity_12412_description",
						8633: "activity_8633_description",
						8634: "activity_8634_description",
						12413: "activity_12413_description",
						10549: "activity_10549_description"
						
					},
					
					activitynotavailablemessagecontrolids: {
					
						8629: "activity_8629_notavailablemessage",
						8630: "activity_8630_notavailablemessage",
						12411: "activity_12411_notavailablemessage",
						8631: "activity_8631_notavailablemessage",
						8632: "activity_8632_notavailablemessage",
						12412: "activity_12412_notavailablemessage",
						8633: "activity_8633_notavailablemessage",
						8634: "activity_8634_notavailablemessage",
						12413: "activity_12413_notavailablemessage",
						10549: "activity_10549_notavailablemessage"
						
					},

					guesttypecontrolids: {
						
						274: "guests_g1009_t274",
						1554: "guests_g1009_t1554",
						1190: "guests_g1009_t1190"
				...
				function bookKuoalaTaste(group) {
					...
					setpromotionalcode(document.getElementById('promotionalcode_g1009').value); 
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h3>Taste of Kualoa Farm Tour</h3> <a class="close" href="#" rel="modal:close"><i class="fa fa-times" aria-hidden="true"></i></a>
					...
					<div class="modal-body" data-step="1">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g1009_t274" onchange="showPriceAndAvailability(group1009);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g1009_t1554" onchange="showPriceAndAvailability(group1009);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g1009_t1190" onchange="showPriceAndAvailability(group1009);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper date-selector">
								<input id="date_g1009" class="form-control browser-default" onclick="showCalendar(group1009);" onchange="showPriceAndAvailability(group1009);" readOnly />
								<a onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" href="javascript:showCalendar(group1009);" style="vertical-align: middle;"><i class="fa fa-calendar" aria-hidden="true"></i></a>
							</div>
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select id="kualoa-tour-times" class="groupSelect form-control activity-time browser-default" onchange="showPriceAndAvailability(group1009);" onclick="showPriceAndAvailability(group1009);">

								  <option value="0" onclick="selectActivity(group1009, this); showPriceAndAvailability(group1009);">Select time</option>

								  <option id="activity_8629" onclick="selectActivity(group1009, this); showPriceAndAvailability(group1009);"> 8:45 AM </option>
								  <option id="activity_8630" onclick="selectActivity(group1009, this); showPriceAndAvailability(group1009);"> 9:15 AM </option>
								  <option id="activity_12411" onclick="selectActivity(group1009, this); showPriceAndAvailability(group1009);"> 10:00 AM </option>
								  <option id="activity_8631" onclick="selectActivity(group1009, this); showPriceAndAvailability(group1009);"> 10:30 AM </option>
								  <option id="activity_8632" onclick="selectActivity(group1009, this); showPriceAndAvailability(group1009);"> 11:00 AM </option>
								  <option id="activity_12412" onclick="selectActivity(group1009, this); showPriceAndAvailability(group1009);"> 11:45 AM </option>
								  <option id="activity_8633" onclick="selectActivity(group1009, this); showPriceAndAvailability(group1009);"> 12:45 PM </option>
								  <option id="activity_8634" onclick="selectActivity(group1009, this); showPriceAndAvailability(group1009);"> 1:15 PM </option>
								  <option id="activity_12413" onclick="selectActivity(group1009, this); showPriceAndAvailability(group1009);"> 2:00 PM </option>
								  <option id="activity_10549" onclick="selectActivity(group1009, this); showPriceAndAvailability(group1009);"> 2:30 PM </option>
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<input type="text" class="form-control" id="promotionalcode_g1009" size="8">
						...
						<div class="form-row total-price">
							<label>Total Price with taxes: <span id="price_g1009"></span></label>
						</div>
					...
					<div class="modal-footer">
						...
						<a href="#" class="btn btn-default btn-book-now" onclick="bookKuoalaTaste(group1009);">Book Now</a>

<!-- The Modal -->
<div id="modal-emountain-bike-tour" class="ponorezmodal">
			...
			<script type="text/javascript">
				...
				var group1001 = {
					...
					activityprices: {
						...
						10328: { 274: 115.13, 3341: 94.19 },
						10017: { 274: 115.13, 3341: 94.19 }				
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h3>e-Mountain Bike Tour</h3> <a class="close" href="#" rel="modal:close"><i class="fa fa-times" aria-hidden="true"></i></a>
					...
					<div class="modal-body" data-step="1">
						...
						<div class="form-row">
							...
							<label>Child (5-12 years old)</label>

							<div class="input-wrapper">

								<select class="form-control browser-default" id="guests_g1001_t3341" onchange="showPriceAndAvailability(group1001);">
					...
					<div class="modal-footer">
						...
						<a href="#" class="btn btn-default btn-book-now" onclick="bookeBike(group1001);">Book Now</a>

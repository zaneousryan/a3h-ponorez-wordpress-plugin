<!-- The Modal -->
<div id="modal-1hour-ebike" class="ponorezmodal">
		...
		<form class="booking-form">
			...
			<script type="text/javascript">
				...
				var group1023 = {
					...
					supplierid: 225,
					activityids: [ 11751, 12520, 12621 ],
					guesttypeids: [ 274, 1554 ],

					activityprices: {

						11751: { 274: 80.58, 1554: 62.78 },				
						12520: { 274: 80.58, 1554: 62.78 },				
						12621: { 274: 80.58, 1554: 62.78 }				

					},

					datecontrolid: 'date_g1023',
					pricecontrolid: 'price_g1023',

					activitycheckboxcontrolids: {

						11751: 'activity_11751',
						12520: 'activity_12520',
						12621: 'activity_12621'

					},

					activitydescriptioncontrolids: {

						11751: 'activity_11751_description',
						12520: 'activity_12520_description',
						12621: 'activity_12621_description'

					},

					activitynotavailablemessagecontrolids: {

						11751: 'activity_11751_notavailablemessage',
						12520: 'activity_12520_notavailablemessage',
						12621: 'activity_12621_notavailablemessage'

					},

					guesttypecontrolids: {

						274: 'guests_g1023_t274',
						1554: 'guests_g1023_t1554'
				...
				function book1HReBike(group) {
					...
					setpromotionalcode(document.getElementById('promotionalcode_g1023').value); 
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h3>1-Hour E-Bike Tour</h3> <a class="close" href="#" rel="modal:close"><i class="fa fa-times" aria-hidden="true"></i></a>
					...
					<div class="modal-body" data-step="1">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g1023_t274" onchange="showPriceAndAvailability(group1023);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g1023_t1554" onchange="showPriceAndAvailability(group1023);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper date-selector">
								<input id="date_g1023" class="form-control browser-default" onclick="showCalendar(group1023);" onchange="showPriceAndAvailability(group1023);" readOnly />
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select id="ebike-times" class="groupSelect form-control activity-time browser-default" onchange="showPriceAndAvailability(group1023);" onclick="showPriceAndAvailability(group1023);">

									<option value="0" onclick="selectActivity(group1023, this);">Select time</option>

									<option id="activity_11751" onclick="selectActivity(group1023, this);">9:00 AM</option>
									<option id="activity_12520" onclick="selectActivity(group1023, this);">10:30 AM</option>
									<option id="activity_12621" onclick="selectActivity(group1023, this);">11:00 AM</option>
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<input type="text" class="form-control" id="promotionalcode_g1023" size="8">
						...
						<div class="form-row total-price">
							<label>Total Price with taxes: <span id="price_g1023"></span></label>
						</div>
					...
					<div class="modal-footer">
						...
						<a href="#" class="btn btn-default btn-book-now" onclick="book1HReBike(group1023);">Book Now</a>

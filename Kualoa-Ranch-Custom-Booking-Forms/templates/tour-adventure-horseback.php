<!-- The Modal -->
<div id="modal-horseback-adventure" class="ponorezmodal">
		...
		<form class="booking-form">
			...
			<script type="text/javascript">
				...
				var group1006 = {
					...
					supplierid: 225,
					activityids: [ 12420, 12428, 12421, 12423, 12424 ],
					guesttypeids:[ 274, 1554 ],
					
					activityprices: {
						
						12420: { 274: 177.96, 1554: 119.32 },
						12428: { 274: 177.96, 1554: 119.32 },
						12421: { 274: 177.96, 1554: 119.32 },
						12423: { 274: 177.96, 1554: 119.32 },
						12424: { 274: 177.96, 1554: 119.32 }
						
					},

					datecontrolid: "date_g1006",
					pricecontrolid: "price_g1006",
					
					activitycheckboxcontrolids: {
						
						12420: "activity_12420",
						12428: "activity_12428",
						12421: "activity_12421",
						12423: "activity_12423",
						12424: "activity_12424"
						
					},
					
					activitydescriptioncontrolids: {
						
						12420: "activity_12420_description",
						12428: "activity_12428_description",
						12421: "activity_12421_description",
						12423: "activity_12423_description",
						12424: "activity_12424_description"
						
					},
					
					activitynotavailablemessagecontrolids: {
						
						12420: "activity_12420_notavailablemessage",
						12428: "activity_12428_notavailablemessage",
						12421: "activity_12421_notavailablemessage",
						12423: "activity_12423_notavailablemessage",
						12424: "activity_12424_notavailablemessage"
					},
					
					guesttypecontrolids: {
						
						274: "guests_g1006_t274",
						1554: "guests_g1006_t1554"
				...
				function bookAdventureHorseback(group) {
					...
					setpromotionalcode(document.getElementById('promotionalcode_g1006').value); 
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h3>Horseback Adventure</h3> <a class="close" href="#" rel="modal:close"><i class="fa fa-times" aria-hidden="true"></i></a>
					...
					<div class="modal-body" data-step="1">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g1006_t274" onchange="showPriceAndAvailability(group1006);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g1006_t1554" onchange="showPriceAndAvailability(group1006);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper date-selector">
								<input id="date_g1006" class="form-control browser-default" onclick="showCalendar(group1006);" onchange="showPriceAndAvailability(group1006);" readOnly />
								<a onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" href="javascript:showCalendar(group1006);" style="vertical-align: middle;"><i class="fa fa-calendar" aria-hidden="true"></i></a>
							</div>
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select id="adventure-horseback-times" class="groupSelect form-control activity-time browser-default" onchange="showPriceAndAvailability(group1006);" onclick="showPriceAndAvailability(group1006);">

									<option value="0" onclick="selectActivity(group1006, this);">Select time</option>

									<option id="activity_12420" onclick="selectActivity(group1006, this);"> 8:00 AM </option>
									<option id="activity_12428" onclick="selectActivity(group1006, this);"> 8:00 AM </option>
									<option id="activity_12421" onclick="selectActivity(group1006, this);"> 8:00 AM </option>
									<option id="activity_12423" onclick="selectActivity(group1006, this);"> 8:00 AM </option>
									<option id="activity_12424" onclick="selectActivity(group1006, this);"> 8:00 AM </option>
									
								</select>
								
								<script>
									
									$("#adventure-horseback-times").bind("click", function() {
									
										if ( $('body select#adventure-horseback-times:not(:disabled) option:not(:disabled)').length == 1 && $('body select#adventure-horseback-times:not(:disabled) option:not(:disabled)').val() == '0' ) {
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<input type="text" class="form-control" id="promotionalcode_g1006" size="8">
						...
						<div class="form-row total-price">
							<label>Total Price with taxes: <span id="price_g1006"></span></label>
						</div>
					...
					<div class="modal-footer">
						...
						<a href="#" class="btn btn-default btn-book-now" onclick="bookAdventureHorseback(group1006);">Book Now</a>

<!-- The Modal -->
<div id="modal-2hour-atv" class="ponorezmodal">
		...
		<form class="booking-form">
			...
			<script type="text/javascript">
				...
				var group1011 = {
					...
					supplierid: 225,
					activityids: [ 7575, 7579, 7581, 7584, 10196, 7586, 7587 ],
					guesttypeids: [ 274 ],
					...
					datecontrolid: "date_g1011",
					pricecontrolid: "price_g1011",
					...
					activitydescriptioncontrolids: {
						...
						7575: "activity_7575_description",
						7579: "activity_7579_description",
						7581: "activity_7581_description",
						7584: "activity_7584_description",
						10196: "activity_10196_description",
						7586: "activity_7586_description",
						7587: "activity_7587_description"
						
					},
					
					activitynotavailablemessagecontrolids: {
						
						7575: "activity_7575_notavailablemessage",
						7579: "activity_7579_notavailablemessage",
						7581: "activity_7581_notavailablemessage",
						7584: "activity_7584_notavailablemessage",
						10196: "activity_10196_notavailablemessage",
						7586: "activity_7586_notavailablemessage",
						7587: "activity_7587_notavailablemessage"
					
					},
					
					guesttypecontrolids: {
						
						274: "guests_g1011_t274"
				...
				function book2hrsATV(group) {
					...
					setpromotionalcode(document.getElementById('promotionalcode_g1011').value); 
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h3>2-Hour ATV Tour</h3> <a class="close" href="#" rel="modal:close"><i class="fa fa-times" aria-hidden="true"></i></a>
					...
					<div class="modal-body" data-step="1">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g1011_t274" onchange="showPriceAndAvailability(group1011);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper date-selector">
								<input id="date_g1011" class="form-control browser-default" onclick="showCalendar(group1011);" onchange="showPriceAndAvailability(group1011);" readOnly />
								<a onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" href="javascript:showCalendar(group1011);" style="vertical-align: middle;"><i class="fa fa-calendar" aria-hidden="true"></i></a>
							</div>
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select id="2hr-atv-times" class="groupSelect form-control activity-time browser-default" onchange="showPriceAndAvailability(group1011);" onclick="showPriceAndAvailability(group1011);">

									<option value="0" onclick="selectActivity(group1011, this); showPriceAndAvailability(group1011);">Select time</option>

									<option id="activity_7575" onclick="selectActivity(group1011, this); showPriceAndAvailability(group1011);"> 8:30 AM </option>
									<option id="activity_7579" onclick="selectActivity(group1011, this); showPriceAndAvailability(group1011);"> 9:30 AM </option>
									<option id="activity_7581" onclick="selectActivity(group1011, this); showPriceAndAvailability(group1011);"> 11:15 AM </option>
									<option id="activity_7584" onclick="selectActivity(group1011, this); showPriceAndAvailability(group1011);"> 12:15 PM </option>
									<option id="activity_10196" onclick="selectActivity(group1011, this); showPriceAndAvailability(group1011);"> 1:30 PM </option>
									<option id="activity_7586" onclick="selectActivity(group1011, this); showPriceAndAvailability(group1011);"> 1:45 PM </option>
									<option id="activity_7587" onclick="selectActivity(group1011, this); showPriceAndAvailability(group1011);"> 3:30 PM </option>

								</select>
								
								<script>
									
									$("#2hr-atv-times").bind("click", function() {
									
										if ( $('body select#2hr-atv-times:not(:disabled) option:not(:disabled)').length == 1 && $('body select#2hr-atv-times:not(:disabled) option:not(:disabled)').val() == '0' ) {
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<input type="text" class="form-control" id="promotionalcode_g1011" size="8">
						...
						<div class="form-row total-price">
							<label>Total Price with taxes: <span id="price_g1011"></span></label>
						</div>
					...
					<div class="modal-footer">
						...
						<a href="#" class="btn btn-default btn-book-now" onclick="book2hrsATV(group1011);">Book Now</a>

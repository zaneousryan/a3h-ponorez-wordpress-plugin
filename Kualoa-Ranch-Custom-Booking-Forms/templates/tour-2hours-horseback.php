    ...
    <div class="modal-form-content">
        ...
        <form class="booking-form">
            ...
            <script type="text/javascript">
                console.log('2hour-horseback-tour - upper');
                ...
                function showPriceAndAvailability(group) {
                    console.log('2hour-horseback-tour');
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h3>2-Hour Horseback Tour</h3> <a class="close" href="#" rel="modal:close"><i
                    ...
                    <div class="modal-body" data-step="1">
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-wrapper">
                                ...
                                <select class="form-control browser-default" id="guests_g1003_t274"
                                    onchange="showPriceAndAvailability(group1003);">
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-wrapper">
                                ...
                                <select class="form-control browser-default" id="guests_g1003_t1554"
                                    onchange="showPriceAndAvailability(group1003);">
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-wrapper date-selector">
                                <input id="date_g1003" class="form-control browser-default"
                                    onclick="showCalendar(group1003);" onchange="showPriceAndAvailability(group1003);"
                                    readOnly />
                                <a onMouseOver="window.status='Date Picker';return true;"
                                    onMouseOut="window.status='';return true;"
                                    href="javascript:showCalendar(group1003);" style="vertical-align: middle;"><i
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-wrapper">
                                ...
                                <select id="2hr-horseback-times"
                                    class="groupSelect form-control activity-time browser-default"
                                    onchange="showPriceAndAvailability(group1003);"
                                    onclick="showPriceAndAvailability(group1003);">

                                    <option value="0" onclick="selectActivity(group1003, this);">Select time</option>

                                    <option id="activity_7748" onclick="selectActivity(group1003, this);">8:30 AM
                                    </option>
                                    <option id="activity_7597" onclick="selectActivity(group1003, this);">9:30 AM
                                    </option>
                                    <option id="activity_13099" onclick="selectActivity(group1003, this);">9:45 AM
                                    </option>
                                    <option id="activity_7598" onclick="selectActivity(group1003, this);">11:15 AM
                                    </option>
                                    <option id="activity_13100" onclick="selectActivity(group1003, this);">11:30 AM
                                    </option>
                                    <option id="activity_13101" onclick="selectActivity(group1003, this);">12:00 PM
                                    </option>
                                    <option id="activity_7600" onclick="selectActivity(group1003, this);">12:15 PM
                                    </option>
                                    <option id="activity_7656" onclick="selectActivity(group1003, this);">1:30 PM
                                    </option>
                                    <option id="activity_13102" onclick="selectActivity(group1003, this);">2:00 PM
                                    </option>
                                    <option id="activity_10603" onclick="selectActivity(group1003, this);">2:30 PM
                                    </option>
                                    <option id="activity_10604" onclick="selectActivity(group1003, this);">2:45 PM
                                    </option>
                                    <option id="activity_9155" onclick="selectActivity(group1003, this);">3:00 PM
                                    </option>
                                    <option id="activity_9156" onclick="selectActivity(group1003, this);">3:15 PM
                                    </option>
                                    <option id="activity_7658" onclick="selectActivity(group1003, this);">3:30 PM
                                    </option>
                                    <option id="activity_9157" onclick="selectActivity(group1003, this);">3:45 PM
                                    </option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="form-control" id="promotionalcode_g1003"
                                    onchange="showPriceAndAvailability(group1003);" size="8">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="#" class="btn btn-default btn-book-now" onclick="book2hrsHorseback(group1003);">Book
                            Now</a>

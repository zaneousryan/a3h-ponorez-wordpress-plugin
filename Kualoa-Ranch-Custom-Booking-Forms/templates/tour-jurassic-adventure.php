<!-- The Modal -->
<div id="modal-jurassic-adventure" class="ponorezmodal">
		...
		<form class="booking-form">
			...
			<script type="text/javascript">
				...
				var group1023 = {
					...
					supplierid: 225,
					activityids: [ 13103, 13104,13143],
					guesttypeids: [ 274, 1554 ],

					activityprices: {

						13103: { 274: 136.07, 1554: 73.25 },				
						13143: { 274: 136.07, 1554: 73.25 },				
						13104: { 274: 136.07, 1554: 73.25 }				

					},

					datecontrolid: 'date_g13103',
					pricecontrolid: 'price_g13103',

					activitycheckboxcontrolids: {

						13103: 'activity_13103',
						13104: 'activity_13104',
						13143: 'activity_13143'

					},

					activitydescriptioncontrolids: {

						13103: 'activity_13103_description',
						13104: 'activity_13104_description',
						13143: 'activity_13143_description'

					},

					activitynotavailablemessagecontrolids: {

						13103: 'activity_13103_notavailablemessage',
						13104: 'activity_13104_notavailablemessage',
						13143: 'activity_13143_notavailablemessage'

					},

					guesttypecontrolids: {

						274: 'guests_g13103_t274',
						1554: 'guests_g13103_t1554'
				...
				function bookJurassicAdventure(group) {
					...
					setpromotionalcode(document.getElementById('promotionalcode_g13103').value); 
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h3>Jurassic Adventure Tour</h3> <a class="close" href="#" rel="modal:close"><i class="fa fa-times" aria-hidden="true"></i></a>
					...
					<div class="modal-body" data-step="1">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g13103_t274" onchange="showPriceAndAvailability(group1023);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select class="form-control browser-default" id="guests_g13103_t1554" onchange="showPriceAndAvailability(group1023);">
						...
						<div class="form-row">
							...
							<div class="input-wrapper date-selector">
								<input id="date_g13103" class="form-control browser-default" onclick="showCalendar(group1023);" onchange="showPriceAndAvailability(group1023);" readOnly />
								<a onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" href="javascript:showCalendar(group1023);" style="vertical-align: middle;"><i class="fa fa-calendar" aria-hidden="true"></i></a>
							</div>
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<select id="jurassic-adventure-times" class="groupSelect form-control activity-time browser-default" onchange="showPriceAndAvailability(group1023);" onclick="showPriceAndAvailability(group1023);">

									<option value="0" onclick="selectActivity(group1023, this);">Select time</option>
									
									<option id="activity_13143" onclick="selectActivity(group1023, this);">9:15 AM</option>
									<option id="activity_13103" onclick="selectActivity(group1023, this);">10:30 AM</option>
									<option id="activity_13104" onclick="selectActivity(group1023, this);">1:30 PM</option>

								</select>
								
								<script>
									
									$("#jurassic-adventure-times").bind("click", function() {
									
										if ( $('body select#jurassic-adventure-times:not(:disabled) option:not(:disabled)').length == 1 && $('body select#jurassic-adventure-times:not(:disabled) option:not(:disabled)').val() == '0' ) {
						...
						<div class="form-row">
							...
							<div class="input-wrapper">
								...
								<input type="text" class="form-control" id="promotionalcode_g13103" size="8">
						...
						<div class="form-row total-price">
							<label>Total Price with taxes: <span id="price_g13103"></span></label>
						</div>
					...
					<div class="modal-footer">
						...
						<a href="#" class="btn btn-default btn-book-now" onclick="bookJurassicAdventure(group1023);">Book Now</a>
